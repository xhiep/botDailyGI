...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "gen.no_login":        {"vi": "⚠️ Chưa có tài khoản — dùng /addaccount <tên>", "en": "⚠️ No account found — use /addaccount <name>"},
    ...
    # ── Multi-account ──────────────────────────────────────────────────────
    "acct.empty":              {"vi": "⚠️ Chưa có tài khoản nào. Dùng /addaccount <tên> rồi gửi JSON cookie để thêm.", "en": "⚠️ No accounts yet. Use /addaccount <name> and upload a cookie JSON to add one."},
    "acct.list_header":        {"vi": "🗂️ Tài khoản ({count})", "en": "🗂️ Accounts ({count})"},
    ...
    "acct.status_cookie_bad":  {"vi": "⚠️ Cookie không hợp lệ — dùng /addaccount <tên> rồi gửi lại JSON", "en": "⚠️ Cookie invalid — use /addaccount <name> and upload a new JSON"},
    ...
    "acct.update_import_open": {"vi": "♻️ Mở phiên cập nhật cookie cho **{name}**...", "en": "♻️ Opening a cookie refresh session for **{name}**..."},
    ...
    "acct.import.no_pending":  {"vi": "ℹ️ Hiện không có phiên /addaccount nào đang chờ file JSON.", "en": "ℹ️ There is no pending /addaccount session waiting for a JSON file."},
    ...
    "status.resin_bar":    {"vi": "⚗️ Nhựa: [{bar}] {cur}/{max}{eta}", "en": "⚗️ Resin: [{bar}] {cur}/{max}{eta}"},
    ...
    "resin.title":         {"vi": "⚗️ Nhựa — {nickname}", "en": "⚗️ Resin — {nickname}"},
    ...
    "resin.notify.multi_header": {"vi": "⚗️ Thông báo nhựa theo tài khoản", "en": "⚗️ Per-account resin alerts"},
    ...
    "resin.alert.threshold":    {"vi": "⚗️ NHỰA ĐÃ ĐẠT NGƯỠNG!\n👤 {nickname}\n💧 Nhựa: {full_str}\n⚠️ Ngưỡng: {threshold}/{max}\n💡 Vào farm nhựa kẻo tràn!{hint}", "en": "⚗️ RESIN REACHED THRESHOLD!\n👤 {nickname}\n💧 Resin: {full_str}\n⚠️ Threshold: {threshold}/{max}\n💡 Farm resin before it caps!{hint}"},
    ...
    "checkin.already":     {"vi": "ℹ️ Hôm nay đã điểm danh rồi! (Tích lũy: {total} ngày)", "en": "ℹ️ Already checked in today! (Accumulated: {total} days)"},
    ...
    "checkin.auto.no_cookie":  {"vi": "⚠️ Auto check-in thất bại: {err}", "en": "⚠️ Auto check-in failed: {err}"},
    "checkin.auto.already":    {"vi": "{label} Hôm nay đã điểm danh rồi ✅", "en": "{label} Already checked in today ✅"},
    "checkin.auto.already2":   {"vi": "{label} ℹ️ Đã điểm danh rồi ({msg})", "en": "{label} ℹ️ Already checked in ({msg})"},
    "checkin.auto.success":    {"vi": "{label} ✅ Điểm danh thành công!", "en": "{label} ✅ Check-in successful!"},
    "checkin.auto.retry":      {"vi": "⚠️ {label} Điểm danh lần {attempt} thất bại: {msg}\n⏳ Thử lại sau {wait_m} phút...", "en": "⚠️ {label} Check-in attempt {attempt} failed: {msg}\n⏳ Retrying in {wait_m} mins..."},
    ...
    "live.no_schedule":    {"vi": "⚠️ Không tìm được lịch — thử lại sau.", "en": "⚠️ Schedule not found — try again later."},
    ...
    "abyss.caption":       {"vi": "🌀 SPIRAL ABYSS [{label}] — {nickname}\n⭐ {stars}/36   🏆 {floor}   ⚔️ {battles} trận", "en": "🌀 SPIRAL ABYSS [{label}] — {nickname}\n⭐ {stars}/36   🏆 {floor}   ⚔️ {battles} battles"},
    ...
    "abyss.stats":         {"vi": "⭐ {stars}/36   🏆 {floor}   ⚔️ {battles} trận ({wins} thắng)", "en": "⭐ {stars}/36   🏆 {floor}   ⚔️ {battles} battles ({wins} wins)"},
    ...
    # ── Gift codes ────────────────────────────────────────────────────────
    "code.usage":          {"vi": "⚠️ Dùng: /redeem ABCD1234", "en": "⚠️ Usage: /redeem ABCD1234"},
    ...
    "code.no_codes":       {"vi": "⚠️ Không có code nào trong codes.txt", "en": "⚠️ No codes found in codes.txt"},
    "code.bl_empty":       {"vi": "✅ Blacklist trống.", "en": "✅ Blacklist is empty."},
    "code.bl_already_empty":{"vi": "ℹ️ Blacklist đã trống rồi.", "en": "ℹ️ Blacklist is already empty."},
    ...
    "heartbeat.resin":     {"vi": "\n⚗️ Nhựa: [{bar}] {cur}/{max}{eta}", "en": "\n⚗️ Resin: [{bar}] {cur}/{max}{eta}"},
    ...
    "code.redeem.all_bl":     {"vi": "⚠️ Toàn bộ {count} code đã trong blacklist.", "en": "⚠️ All {count} codes are already blacklisted."},
    ...
    "code.redeem.fail_other": {"vi": "⚠️ Lỗi khác ({count}):", "en": "⚠️ Other errors ({count}):"},
    "code.redeem.skipped":    {"vi": "⏭️ Đã bỏ qua {count} code (đã blacklist)", "en": "⏭️ Skipped {count} codes (already blacklisted)"},

    # ── Cookie status (check_cookie_status) ───────────────────────────────
    "cookie.status_ok":   {"vi": "✅ Hợp lệ — {nickname}", "en": "✅ Valid — {nickname}"},
    "cookie.status_err":  {"vi": "⚠️ retcode {code}: {msg}", "en": "⚠️ retcode {code}: {msg}"},
